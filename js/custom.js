...
function typer() {
    var win = $(window),
        foo = $('#typer');
    foo.typer(['<h1><span class="iq-font-purple">Technology</span> Consultant</h1>', '<h1>Project<span class="iq-font-purple"> Manager</span></h1>', '<h1>Civil<span class="iq-font-purple"> Engineer</span></h1>', '<h1>Data Science<span class="iq-font-purple"> Manager</span></h1>']);
